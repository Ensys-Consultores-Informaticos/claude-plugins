...
<!-- solo-cowork:alt=**El destino es la carpeta del expediente**, directamente: `<expediente>/InformesGesia/CuestionarioCuentasAnuales/`. Vale igual para el papel de trabajo del paso siguiente. -->**El destino depende del entorno.** En la máquina del auditor, directamente
